...
ПРИОРИТЕТ ДАННЫХ:
- SofaScore — ОСНОВНОЙ: оборона, дриблинг, единоборства, пасы, рейтинг. Данные ПО КАЖДОМУ ТУРНИРУ отдельно.
...
4) Кубки и еврокубки (ОБЯЗАТЕЛЬНЫЙ блок если данные есть):
   Отдельный блок: сравни рейтинг/стату в лиге vs ЛЧ/ЛЕ/кубках. Показывает ли себя на большой сцене?
   Перечисли ключевые матчи с тегами [ФИНАЛ], [ПОЛУФИНАЛ] если есть.
