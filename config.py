...
MODEL_ORCHESTRATOR = os.environ.get("MODEL_ORCHESTRATOR", "xiaomi/mimo-v2-flash")  # skill router
...
MODEL_SEARCH = os.environ.get("MODEL_SEARCH", "perplexity/sonar")  # web search (built-in)
